...
package com.hrbnu.demo12306.framework.starter.log.core;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.date.SystemClock;
import com.alibaba.fastjson2.JSON;
import com.hrbnu.demo12306.framework.starter.log.annotation.ILog;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(com.hrbnu.demo12306.framework.starter.log.annotation.ILog) || @annotation(com.hrbnu.demo12306.framework.starter.log.annotation.ILog)")
