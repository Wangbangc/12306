...
const checkTagCardType = ref(true)
const departureTagAll = ref(true)
const arrivalTagAll = ref(true)
const seatTagAll = ref(true)
...
export  default {
  beforeDestroy(){
    this.$refs.checkboxGroup.$off('change', this.seatTagAll);
    this.$refs.checkboxGroup.$off('change', this.arrivalTagAll);
    this.$refs.checkboxGroup.$off('change', this.departureTagAll);
    this.$refs.checkboxGroup.$off('change', this.checkTagCardType);
  }
}
</script>
