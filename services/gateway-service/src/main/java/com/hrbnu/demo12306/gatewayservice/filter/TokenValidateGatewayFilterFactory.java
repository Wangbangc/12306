...
package com.hrbnu.demo12306.gatewayservice.filter;

import com.alibaba.nacos.client.naming.utils.CollectionUtils;
import com.hrbnu.demo12306.gatewayservice.config.Config;
import com.hrbnu.demo12306.gatewayservice.toolkit.JWTUtil;
import com.hrbnu.demo12306.gatewayservice.toolkit.UserInfoDTO;
        ...
        return (exchange, chain) -> {
            ...
            if (isPathInBlackPreList(requestPath, config.getBlackPathPre())) {
                ...
                ServerHttpRequest.Builder builder = exchange.getRequest().mutate().headers(httpHeaders -> {
                    ...
                    try {
                        httpHeaders.set(UserConstant.REAL_NAME_KEY, URLEncoder.encode(userInfo.getRealName(), String.valueOf(StandardCharsets.UTF_8)));
