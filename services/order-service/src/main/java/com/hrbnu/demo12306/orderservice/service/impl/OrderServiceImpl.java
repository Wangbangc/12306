...
package com.hrbnu.demo12306.orderservice.service.impl;
...
import com.hrbnu.demo12306.orderservice.common.enums.OrderCanalErrorCodeEnum;
import com.hrbnu.demo12306.orderservice.common.enums.OrderItemStatusEnum;
import com.hrbnu.demo12306.orderservice.common.enums.OrderStatusEnum;
import com.hrbnu.demo12306.orderservice.service.OrderItemService;
import com.hrbnu.demo12306.orderservice.service.OrderPassengerRelationService;
import com.hrbnu.demo12306.orderservice.service.OrderService;
import com.hrbnu.demo12306.orderservice.service.orderid.OrderIdGeneratorManager;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.apache.rocketmq.client.producer.SendResult;
import org.apache.rocketmq.client.producer.SendStatus;
import com.hrbnu.demo12306.orderservice.dao.entity.OrderDO;
import com.hrbnu.demo12306.orderservice.dao.entity.OrderItemDO;
import com.hrbnu.demo12306.orderservice.dao.entity.OrderItemPassengerDO;
import com.hrbnu.demo12306.orderservice.dao.mapper.OrderItemMapper;
import com.hrbnu.demo12306.orderservice.dao.mapper.OrderMapper;
import com.hrbnu.demo12306.orderservice.dto.domain.OrderStatusReversalDTO;
import com.hrbnu.demo12306.orderservice.dto.req.CancelTicketOrderReqDTO;
import com.hrbnu.demo12306.orderservice.dto.req.TicketOrderCreateReqDTO;
import com.hrbnu.demo12306.orderservice.dto.req.TicketOrderItemCreateReqDTO;
import com.hrbnu.demo12306.orderservice.dto.req.TicketOrderPageQueryReqDTO;
import com.hrbnu.demo12306.orderservice.dto.req.TicketOrderSelfPageQueryReqDTO;
import com.hrbnu.demo12306.orderservice.dto.resp.TicketOrderDetailRespDTO;
import com.hrbnu.demo12306.orderservice.dto.resp.TicketOrderDetailSelfRespDTO;
import com.hrbnu.demo12306.orderservice.dto.resp.TicketOrderPassengerDetailRespDTO;
import com.hrbnu.demo12306.orderservice.mq.event.DelayCloseOrderEvent;
import com.hrbnu.demo12306.orderservice.mq.event.PayResultCallbackOrderEvent;
import com.hrbnu.demo12306.orderservice.mq.produce.DelayCloseOrderSendProduce;
import com.hrbnu.demo12306.orderservice.remote.UserRemoteService;
import com.hrbnu.demo12306.orderservice.remote.dto.UserQueryActualRespDTO;
import com.hrbnu.demo12306.framework.starter.common.toolkit.BeanUtil;
...
import com.hrbnu.demo12306.framework.starter.convention.page.PageResponse;
import com.hrbnu.demo12306.framework.starter.convention.result.Result;
import com.hrbnu.demo12306.framework.starter.database.toolkit.PageUtil;
